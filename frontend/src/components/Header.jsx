...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-[#5f6FFF] rounded-lg px-6 md:px-10 lg:px-20'>
        {/* {=================== Left Side ===================} */}
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-6 py-10 m-auto md:py-[10vw] md:mb-[-40px]'>
            ...
            <div className='flex flex-col md:flex-row items-center gap-4 text-white text-sm font-light'>
                ...
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. <br className='hidden sm:block' /> Iusto alias ipsam accusamus aperiam itaque
                </p>
            </div>
        ...
        <div className='md:w-1/2 relative'>
            <img className='w-130 md:absolute bottom-0 h-auto rounded-lg' src={assets.header_img} alt="" />
        </div>
    </div>
  )
}
