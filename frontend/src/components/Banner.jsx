    ...
    return (
        <div className='flex bg-[#5f6FFF] rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
            ...
            <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5'>
                ...
                <button onClick={() => {navigate('/register'); scrollTo(0,0)}} href='#speciality' className=' bg-white px-8 py-3 rounded-full text-gray-600 text-sm sm:text-base mt-6 hover:scale-105 transition-all duration-300'>
                    Create Account 
                </button>
            </div>
