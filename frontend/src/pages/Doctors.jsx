...
const Doctors = () => {
  ...
  return (
    <div>
      <p className='text-gray'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos, dolore.</p>
      <div className='flex flex-col sm:flex-row gap-5 mt-5 items-start'>
        ...
        <div className='w-full grid grid-cols-[repeat(auto-fill,minmax(200px,_1fr))] gap-4 gap-y-6'>
